...
function formatDate(dateString, i18n, t) {
  if (!dateString)
    return t("present") || (i18n.language === "ar" ? "الآن" : "Present");
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              style={{
                ...
                width: "clamp(260px, 26.8vw, 412px)",
              }}
          ...
          {selectedItem ? (
            <div className="p-10 md:p-14 mx-auto w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                ...
                <DetailRow
                  icon={
                    <Briefcase style={{ width: ICON_SM, height: ICON_SM }} />
                  }
                  label={t("participationType")}
                  value={t(selectedItem.participationType)}
                  color={THEME_COLOR}
                  {...{ FS_XS, FS_SM, LH_TIGHT }}
                />
                <DetailRow
...
export default memo(TrainingProgramsTable);
