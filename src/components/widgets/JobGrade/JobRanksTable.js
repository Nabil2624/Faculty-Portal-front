          ...
          {data.length === 0 ? (
            ...
            data.map((item) => (
              ...
              >
                ...
                <div
                  className="flex justify-end items-center mt-3 opacity-70 font-semibold"
                  style={{ fontSize: FS_XS }}
                >
                  <span className="shrink-0 bg-gray-100 px-3 py-1 rounded italic">
                    {formatDate(item.dateOfJobRank, i18n, t)}
                  </span>
                </div>
              </div>
            ))
            ...
            <div className="p-10 md:p-14 mx-auto w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                <DetailRow
                  ...
                  label={t("gradeDate")}
                  value={formatDate(selectedItem.dateOfJobRank, i18n, t)}
                  color={THEME_COLOR}
                  FS_XS={FS_XS}
                  FS_SM={FS_SM}
                  LH_TIGHT={LH_TIGHT}
                ...
                >
                  ...
                  >
                    {selectedItem.notes || t("noNotesAdded")}
                  </p>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="flex items-start gap-5 min-w-0">
      ...
      <div className="min-w-0 flex-1">
        <p
          className="uppercase mb-1 font-semibold opacity-60"
...
export default memo(JobRanksTable);
