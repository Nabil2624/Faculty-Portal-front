...
// --- 4. المكون الرئيسي ---
const AcademicQualificationsTable = ({
  data = [],
  onEdit,
  onDelete,
  onAdd,
            ...
            <div className="p-10 md:p-14 mx-auto w-full">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-8 mb-12 border-b pb-10">
                <div className="flex-1 min-w-0">
                  ...
                  >
                    <GraduationCap
                      style={{ width: ICON_MD, height: ICON_MD }}
                    />
                    <span
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                ...
                <DetailRow
                  ...
                  label={t("date")}
                  value={formatDate(
                    selectedItem.dateOfObtainingTheQualification,
                    i18n,
                    t,
                  )}
                  color={THEME_COLOR}
                  ...
                  <div className="flex flex-wrap gap-4">
                    {selectedItem.attachments.map((file) => (
                      <button
                        ...
                        className="flex items-center gap-3 bg-white px-4 py-2 rounded-lg border hover:border-[#b38e19] transition-all group shadow-sm"
                      >
                        <Download
                          size={16}
                          className="text-gray-400 group-hover:text-[#b38e19]"
                        />
                        <span className="text-sm font-medium group-hover:text-[#b38e19]">
                          {file.fileName}
                        </span>
                      </button>
                    ))}
...
export default memo(AcademicQualificationsTable);
