...
import { Trophy, Medal, Award, Star, Globe, TrendingUp } from "lucide-react";

const UniversityTopResearchers = ({ title = "التصنيف العام للباحثين" }) => {
  ...
  useEffect(() => {
    setTimeout(() => {
      const universityStars = [
        { id: 1, name: "أ.د. أحمد هشام محمد", dept: "هندسة النظم", papers: 124, score: 98.5 },
        { id: 2, name: "د. سارة محمود علي", dept: "ذكاء اصطناعي", papers: 98, score: 94.2 },
        { id: 3, name: "د. ياسين إبراهيم", dept: "العلوم الأساسية", papers: 85, score: 91.8 },
        { id: 4, name: "د. منى القاضي", dept: "طب الفم", papers: 72, score: 88.5 },
        { id: 5, name: "د. عمر خالد", dept: "الصيدلة", papers: 65, score: 85.0 },
      ];
      setResearchers(universityStars);
      setLoading(false);
    }, 600);
  }, []);
  ...
  return (
    <div className="w-full h-full bg-white shadow-[0_10px_30px_rgba(25,53,90,0.15)] rounded-[2rem] overflow-hidden border border-gray-100 flex flex-col transition-all duration-500">
      ...
      <div className="py-2 px-4 bg-gray-50/50">
        ...
        {/* العنصر الجمالي لوزن المحاذاة مع الدروب داون في الكارت المجاور */}
