...
const UniversityTopResearchers = ({
  title = "التصنيف العام للباحثين",
  data = [],
  footerText,
  noData,
  subTitle,
  ...
  return (
    <div className="w-full h-full bg-white shadow-[0_10px_30px_rgba(25,53,90,0.15)] rounded-[2rem] overflow-hidden border border-gray-100 flex flex-col transition-all duration-500">
      ...
      <div className="py-2 px-4 bg-gray-50/50 flex-grow">
        <div className="relative mb-2 mt-2 h-[46px] flex items-center">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center py-20">
            <p className="flex text-xs text-center items-center font-semibold">
              {noData}
            </p>
          </div>
        ) : (
