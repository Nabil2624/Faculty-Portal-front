...
export default function ScientificWritingDetailsModal({ item, onClose }) {
    ...
    >
      ...
      >
        <div className="flex justify-between gap-3">
          <span className="font-medium">{t("authorRole")}</span>
          <span>
            {isArabic ? item.authorRole.valueAr : item.authorRole.valueAr}
          </span>
        </div>
        {/* Publishing Date */}
        <div className="flex justify-between gap-3">
          <span className="font-medium">{t("publishingDate")}</span>
          <span>{formatDate(item.publishingDate, i18n, t)}</span>
        </div>
        <div className="flex justify-between gap-3">
        ...
        <div className="flex justify-between gap-3">
          <span className="font-medium">{t("publishingHouse")}</span>
