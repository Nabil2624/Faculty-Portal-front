    ...
    return (
      <div className="p-3 border-b bg-gray-50 flex items-center justify-between gap-4 shrink-0">
        <div
          ...
          style={{
            width: selectedItem ? MASTER_WIDTH : "clamp(200px, 40vw, 420px)",
          }}
        >
          <div className="relative flex items-center">
            <div className="absolute start-2 z-10 text-gray-400 group-focus-within:text-[#b38e19] transition-colors">
...
const ScientificMissionsTable = ({
  ...
  const { t: localT, i18n } = useTranslation("ScientificMissions");
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        >
          {selectedItem ? (
            <div className="p-10 md:p-14  mx-auto w-full">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-8 mb-12 border-b pb-10">
                <div className="flex-1 min-0">
                  ...
                  >
                    <PlaneTakeoff style={{ width: ICON_MD, height: ICON_MD }} />
                    <span
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                <DetailRow
                  icon={<School style={{ width: ICON_SM, height: ICON_SM }} />}
                  label={t("institution")}
                  value={selectedItem.universityOrFaculty}
                  color={THEME_COLOR}
                  FS_XS={FS_XS}
                  FS_SM={FS_SM}
                  LH_TIGHT={LH_TIGHT}
                ...
                <DetailRow
                  ...
                  label={t("location")}
                  value={selectedItem.countryOrCity}
                  color={THEME_COLOR}
                  FS_XS={FS_XS}
                  FS_SM={FS_SM}
                  LH_TIGHT={LH_TIGHT}
            ...
            <div className="text-center opacity-10 select-none flex flex-col items-center justify-center h-full">
              <Globe
                style={{ width: ICON_LG, height: ICON_LG }}
                className="mb-8"
              />
              <p className="font-black uppercase" style={{ fontSize: FS_LG }}>
                {t("selectMissionToPreview")}
              </p>
            </div>
          )}
        </div>
...
export default memo(ScientificMissionsTable);
