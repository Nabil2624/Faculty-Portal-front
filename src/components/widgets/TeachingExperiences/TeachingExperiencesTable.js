  ...
  ({ currentPage, totalPages, onPageChange, isArabic, FS_BASE, ICON_SM }) => {
    return (
      <div className="p-6 border-t bg-gray-50 flex items-center justify-end gap-10 shrink-0">
        <div style={{ fontSize: FS_BASE }} className="font-black text-gray-700">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="hover:scale-110 transition-transform disabled:opacity-30 text-[#b38e19]"
          >
            {isArabic ? (
...
// --- 4. المكون الرئيسي ---
const TeachingExperiencesTable = ({
  data = [],
  onEdit,
  onDelete,
  onAdd,
  ...
  const THEME_COLOR = "#b38e19"; // العودة للجولد كما في باقي السيستم
            ...
            <div className="p-10 md:p-14 mx-auto w-full">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-8 mb-12 border-b pb-10">
                <div className="flex-1 min-w-0">
                  ...
                  >
                    ...
                    >
                      {t("experienceDetails") || "Teaching Details"}
                    </span>
                  </div>
                  <h3
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                <DetailRow
                  ...
                  value={selectedItem.academicLevel}
                  color={THEME_COLOR}
                  FS_SM={FS_SM}
                  LH_TIGHT={LH_TIGHT}
                />
...
export default memo(TeachingExperiencesTable);
