              ...
              >
                <div className="flex items-start gap-0 flex-1 pr-4">
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <p
                      className="text-gray-400 italic font-medium flex flex-wrap gap-x-1 items-center"
                ...
                <div className="hidden md:flex items-center gap-4 lg:gap-10 pt-1 shrink-0">
                  <span
                    className="text-[#19355A] font-semibold w-16 md:w-20 text-center underline decoration-gray-100 underline-offset-8"
