...
import ActionIcons from "../../ui/ActionIcons"; // استدعاء الأكشن أيكونز كما طلبت
import {
  Briefcase,
  Calendar,
  ArrowLeft,
...
const AdministrativePositionsTable = ({
  data = [],
  onEdit,
  onDelete,
  onAdd,
          ...
          {data.length === 0 ? (
            ...
            data.map((item) => (
              ...
              >
                ...
                <h4
                  className="font-semibold text-gray-800 break-words line-clamp-1"
...
export default memo(AdministrativePositionsTable);
