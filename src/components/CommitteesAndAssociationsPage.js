...
export default function CommitteesAndAssociationsPage() {
  ...
  const committees = [
    {
      committeeName: "لجنة التخطيط الاستراتيجي",
      type: "لجنة",
      participationLevel: "عضو أساسي",
      startDate: "يناير 2020",
      endDate: "مارس 2022",
      description: "المشاركة في وضع الخطط الاستراتيجية للمنظمة.",
    },
    {
      committeeName: "جمعية دعم البحث العلمي",
      type: "جمعية",
      participationLevel: "عضو مشارك",
      startDate: "أبريل 2018",
      endDate: "حتى الآن",
      description: "المساهمة في دعم المشاريع البحثية.",
    },
  ];
  ...
  const totalPages = Math.ceil(committees.length / itemsPerPage);
  const paginatedData = committees.slice(
  ...
  const confirmDelete = () => {
    console.log("Deleted:", selectedItem.committeeName);
    setShowModal(false);
  ...
  return (
    <Layout>
      <div className={`${isArabic ? "rtl" : "ltr"} p-6`}>
            ...
            >
              ...
              >
                <Pencil
                  ...
                  onClick={() =>
                    navigate("/edit-committee-association", { state: { item } })
                  }
                />
                <Trash2
        ...
        >
          <button
            onClick={() => navigate("/add-committee-association")}
      ...
      {showDetails && selectedItem && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50">
          <div
            dir={isArabic ? "rtl" : "ltr"}
            className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl w-[520px] max-w-[90%] p-8 relative border-2 border-[#b38e19]"
          >
            <button
            ...
            <h2 className="border-b-2 border-[#b38e19]/40 pb-3 mb-4">
              <h2 className="text-2xl font-bold ">{selectedItem.committeeName}</h2>
            </h2>
           { /* content */}
            <div className="space-y-3 text-gray-700">
              ...
              <div className="flex justify-between">
                ...
                <span>{selectedItem.participationLevel}</span>
              </div>
