...
export default function Projects() {
  ...
  const fetchProjects = async (page = currentPage) => {
    ...
    try {
      const response = await axiosInstance.get(
        "/ProjectsAndCommittees/Projects",
        { params: { pageIndex: page, pageSize }, skipGlobalErrorHandler: true }
      );
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axiosInstance.delete(
        `/ProjectsAndCommittees/DeleteProject/${selectedItem.id}`,
  ...
  return (
    <ResponsiveLayoutProvider>
      <div
        className={`${isArabic ? "rtl" : "ltr"} flex flex-col min-h-[calc(85vh-4rem)] p-4 md:p-6`}
      >
        {/* Header */}
                ...
                >
                  ...
                  >
                    <Pencil
                      ...
                      onClick={() =>
                        navigate("/edit-project", { state: { item } })
                      }
                    />
                    <Trash2
            ...
            >
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {isArabic
                      ? selectedItem.participationRole?.valueAr
                      : selectedItem.participationRole?.valueEn}
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span>
                    {isArabic
                      ? selectedItem.typeOfProject?.valueAr
                      : selectedItem.typeOfProject?.valueEn}
                  </span>
                </div>
                <div className="flex justify-between">
