...
export default function Projects() {
  ...
  const confirmDelete = () => {
    console.log("Deleted:", selectedItem.projectName);
    setShowModal(false);
  ...
  const projectList = [
    {
      projectName: "تطوير المؤسسة الجامعية",
      startDate: "10 مايو 2023",
      endDate: "10 مايو 2024",
      projectType: "مشارك باحث",
      localOrInternational: "محلي",
      fundingAuthority: "وزارة التعليم العالي",
      participationRole: "تنفيذ وتوثيق",
      description:
        "عرض ورقة بحثية عن استخدام الذكاء الاصطناعي في التشخيص الطبي وتحليل الصور الشعاعية.",
    },
    {
      projectName: "مشروع السياحة الإلكترونية",
      startDate: "1 يناير 2024",
      endDate: "1 يناير 2025",
      projectType: "بحثي–تطبيقي",
      localOrInternational: "دولي",
      fundingAuthority: "الاتحاد الأوروبي",
      participationRole: "إدارة المشروع",
      description:
        "عرض ورقة بحثية عن استخدام الذكاء الاصطناعي في التشخيص الطبي وتحليل الصور الشعاعية.",
    },
  ];
  ...
  const paginatedData = projectList.slice(
        ...
        >
          {paginatedData.map((item, idx) => (
            ...
            >
              ...
              <p className="text-sm text-gray-400">{item.projectType}</p>
            </div>
          ))}
        </div>
          ...
          >
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <div className="flex justify-between">
                ...
                <span>{selectedItem.fundingAuthority}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">{t("participationRole")}</span>
                <span>{selectedItem.participationRole}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">{t("projectType")}</span>
                <span>{selectedItem.projectType}</span>
              </div>
