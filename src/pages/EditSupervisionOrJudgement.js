      ...
      <div className="overflow-x-hidden">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-32 mt-12 max-w-[1500px] mx-auto">
            {/* LEFT COLUMN */}
            <div className="space-y-9 md:col-start-2 md:row-start-1 max-w-full md:max-w-[600px] md:pl-24 md:translate-x-20">
              {/* FACULTY ROLE */}
              <div>
            ...
            {/* RIGHT COLUMN */}
            <div className="space-y-8 md:col-start-1 md:row-start-1 md:pl-12 md:translate-x-9">
              {/* THESIS TYPE */}
              <div>
