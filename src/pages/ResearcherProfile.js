...
//   // If scholar profile is missing then show card
//   if (!researcher.scholarProfileLink) {
//     return (
...
if (!researcher && !waiting)
  return <div className="text-center mt-20 text-xl font-semibold">
        {isArabic
