...
const ScientificMissionCategoryPage = () => {
  ...
  const cardsData = [
    { id: "general-mission", titleKey: "generalMission.title", descKey: "generalMission.description", imageUrl: GeneralMissionImg, link: "/forms/general-scientific-mission" },
    { id: "personal-mission", titleKey: "personalMission.title", descKey: "personalMission.description", imageUrl: PersonalMissionImg, link: "/forms/personal-scholarship-mission" },
    { id: "history", titleKey: "historyMission.title", descKey: "historyMission.description", imageUrl: historyImg, link: "/scientific-missions/history" },
  ];
