...
import PersonalMissionImg from "../assets/PersonalMission.avif"; 
import GeneralMissionImg from "../assets/GeneralMission.avif"; 
import historyImg from "../assets/History.png"; 
import PageHeaderAction from "../components/ui/PageHeaderAction";

const ScientificMissionCategoryPage = () => {
  ...
  const cardsData = [
    {
      id: "general-mission",
      titleKey: "generalMission.title",
      descKey: "generalMission.description",
      imageUrl:  GeneralMissionImg, 
      link: "/forms/general-scientific-mission", 
    },
    {
      id: "personal-mission",
      titleKey: "personalMission.title",
      descKey: "personalMission.description",
      imageUrl: PersonalMissionImg, 
      link: "/forms/personal-scholarship-mission", 
    },
    {
      id: "history",
      titleKey: "historyMission.title",
      descKey: "historyMission.description",
      imageUrl: historyImg,
      link: "/scientific-missions/history", 
    },
  ];
  ...
  return (
    <ResponsiveLayoutProvider>
      <div
        ...
        dir={isRtl ? "rtl" : "ltr"}
      >
        {/* عنوان الهيدر للمهمات العلمية */}
        <PageHeaderAction title={t("scientificMissionTitle")} icon={GraduationCap} />
            ...
            {cardsData.map((card) => (
              ...
              >
                ...
                <div className="pt-8 px-8 pb-5 relative flex-1 flex flex-col">
                  ...
                  {/* 🌟 السحر هنا: ديف ميرور كامل للزرار والأرو 🌟 */}
                  <div
...
export default ScientificMissionCategoryPage;