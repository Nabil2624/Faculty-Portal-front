...
const InternalConferenceCategoryPage = () => {
  ...
  const cardsData = [
    {
      id: "attend-qf05",
      titleKey: "attend.title",
      descKey: "attend.description",
      imageUrl: attendImg,
      link: "/forms/qf-05", 
    },
    {
      ...
      descKey: "organize.description",
      imageUrl: origanizeImg,
      link: "/forms/qf-06", 
    },
    {
      id: "history",
      titleKey: "history.title",
      descKey: "history.description",
      imageUrl: historyImg,
      link: "/internal-conferences/history", 
    },
  ];
        ...
        <div className="max-w-7xl mx-auto mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 justify-items-center">
            {cardsData.map((card) => (
              ...
              >
                {/* صورة الكارت الفخمة بالأبعاد الأصلية */}
